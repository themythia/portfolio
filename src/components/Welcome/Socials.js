  ...
  return (
    <div className='flex items-center animate__animated animate__fadeInLeft animate__fast'>
      ...
      <div className='flex w-3/5 sm:w-auto sm:ml-4 md:ml-6 justify-around text-dark/60 dark:text-light/60 text-2xl sm:text-[32px]'>
        <Link type='social' link='https://github.com/themythia'>
          <Icon icon='github' />
        </Link>
        <Link type='social' link='https://www.linkedin.com/in/emiral/'>
          <Icon icon='linkedin' />
        </Link>
        <Link type='social' link='mailto:al.emir@outlook.com'>
          <Icon icon='mail' />
        </Link>
      </div>
    </div>
